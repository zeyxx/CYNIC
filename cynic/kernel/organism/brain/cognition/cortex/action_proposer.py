...
from cynic.kernel.core.events_schema import ActionProposedPayload
from cynic.kernel.core.formulas import ACT_LOG_CAP

logger = logging.getLogger("cynic.kernel.organism.brain.cognition.cortex.action_proposer")
