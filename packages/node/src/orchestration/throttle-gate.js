 ...
 *
 * @module @cynic/node/orchestration/throttle-gate
 */

'use strict';

import { createLogger } from '@cynic/core';
import { BudgetLevel, BudgetRecommendation } from './budget-monitor.js';
...
export class ThrottleGate {
   ...
   * @param {Object} [context] - Optional context for decision (taskType, priority, etc.)
   * @returns {Object} Decision { action, throttleParams, assessment }
   */
  decide(stage, context = {}) {
    this._stats.decisions++;

    // Get current budget assessment
