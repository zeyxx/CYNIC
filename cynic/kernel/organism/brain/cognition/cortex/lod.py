"""
CYNIC SurvivalLOD " Tiered Graceful Degradation (2)
...
4 LOD Levels (-derived thresholds):
...
# Error rate thresholds (-symmetric)
...
# Disk usage thresholds (-derived, fraction of disk used)
...
# Memory usage thresholds (same -scale as disk " fraction of RAM used)
