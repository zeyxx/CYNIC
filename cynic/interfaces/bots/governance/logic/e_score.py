...
E-Scores are -bounded (max 0.618) for natural confidence limits.
"""
...
class EScore:
    ...
    All scores are -bounded (0.618 maximum) for natural confidence limits.
    ...
    def geometric_mean(self) -> float:
        """
        Calculate -bounded overall E-Score using geometric mean.

        Returns:
            Geometric mean of all 7 dimensions, -bounded
        """
        values = [
            self.fidelity,
            self.phi,
