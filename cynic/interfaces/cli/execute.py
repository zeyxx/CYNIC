...
def cmd_execute() -> None:
    ...
    if not args:
        ...
        print(_c("dim", "  Usage: python -m cynic.interfaces.cli execute <action_id>"))
        print(_c("dim", "  Run `python -m cynic.interfaces.cli review` to see pending actions."))
        print()
        return
    ...
    if data is None:
        ...
        print(_c("dim", "  Start: python -m cynic.interfaces.api"))
        print()
        return
    ...
    if executing:
        ...
        print()
        print(_c("dim", "  Claude Code runner spawned. Check `cynic.interfaces.cli sdk` for result."))
    else:
