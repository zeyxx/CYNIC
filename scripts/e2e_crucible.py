...
async def run_proof():
    ...
    try:
        ...
        content = readme_path.read_text(encoding="utf-8", errors="ignore")[:1000] # Take first 1000 chars
        ...
        judgment = await o.cognition.orchestrator.run(cell, level=ConsciousnessLevel.MACRO)
