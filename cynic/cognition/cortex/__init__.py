...
Typical usage:
    from cynic.cognition.cortex import JudgmentOrchestrator
    orchestrator = JudgmentOrchestrator(registry)
    verdict = await orchestrator.judge(cell)

See Also:
    cynic.cognition.neurons: 11 Dog judges
    cynic.api.handlers.judgment_executor: Executes judgment decisions
"""
