...
Next: commit these updates to .claude/projects/-home-user-Bureau-CYNIC/memory/
```

**Permissions required:**
- Read: `.claude/projects/*/` (memory index)
- Read: `MEMORY.md`
- Exec: `scripts/organism-probe.sh`
- Exec: Agent `organism-health-monitor`
- Write: `.claude/projects/*/memory/*.md` (update memories)
