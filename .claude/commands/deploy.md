...
5. Backup DB before deploy: `surreal export --endpoint http://localhost:8000 --namespace cynic --database v2 --username root --password root ~/.surrealdb/backups/cynic_v2_pre_deploy_$(date +%Y%m%d_%H%M%S).surql`
