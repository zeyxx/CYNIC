...
def cmd_watch() -> None:
    ...
    print(_c("dim",  f"  Run 'python -m cynic.interfaces.cli review' when actions appear"))
    print()
    ...
    while True:
        ...
        if new_ids and last_ids:
            ...
            print(f"  → {count} pending  run 'cynic.interfaces.cli review' to process")
...
def cmd_feedback() -> None:
    ...
    if not args:
        print()
        print(_c("bold", "  Usage: python -m cynic.interfaces.cli feedback [1-5]"))
        print()
