...
**Réalité actuelle (2026-06-12) :** 340+ tests. 43/90 findings fixed.
28 méthodes StoragePort. InMemory adapter passes all 13 contract tests.
Cargo.toml = 26.6.12 (date-based YY.M.DD versioning), tag = v0.7.7 (8a874d53). Dev gates use debug builds; release artifacts carry git SHA/checksum metadata.
