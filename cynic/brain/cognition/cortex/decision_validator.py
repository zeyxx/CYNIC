...
from cynic.metabolism.immune.power_limiter import PowerLimiter
from cynic.metabolism.immune.alignment_checker import AlignmentSafetyChecker
from cynic.metabolism.immune.human_approval_gate import HumanApprovalGate
from cynic.metabolism.immune.transparency_audit import TransparencyAuditTrail

logger = logging.getLogger("cynic.brain.cognition.cortex.decision_validator")
...
class DecisionValidator:
    ...
    async def validate_decision(
        ...
        judgment: Any,  # cynic.kernel.core.judgment.Judgment
