...
Typical usage:
    from cynic.kernel.organism.perception.senses import DiscordSensorWorker
...
See Also:
    ...
    cynic.kernel.organism.brain.cognition: Processes sensory input (Cell) through judgment
"""
