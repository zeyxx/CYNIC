...
from cynic.perception.senses import checkpoint as _session_checkpoint
from cynic.perception.senses.checkpoint import CHECKPOINT_EVERY
        ...
        try:
            cell = Cell(
                ...
                metadata={
                    ...
                    "pattern": (
                        event.dict_payload.get("pattern_type", "UNKNOWN")
                        if isinstance(event.dict_payload, dict)
                        else "UNKNOWN"
                    ),
                },
            )
