...
from cynic.brain.cognition.neurons.base import AbstractDog, DogJudgment, DogId
from cynic.brain.cognition.neurons.cynic_dog import CynicDog
from cynic.brain.cognition.cortex.circuit_breaker import CircuitBreaker, CircuitState
from cynic.brain.cognition.cortex.decision_validator import DecisionValidator, BlockedDecision
from cynic.brain.cognition.cortex.handlers import HandlerComposer
from cynic.brain.cognition.cortex.pipeline import JudgmentPipeline
from cynic.brain.cognition.cortex.judgment_stages import execute_judgment_pipeline

logger = logging.getLogger("cynic.brain.cognition.cortex")
...
class JudgeOrchestrator:
    ...
    def _ensure_composer(self) -> None:
        ...
        from cynic.brain.cognition.cortex.handlers import (
    ...
    async def _act_phase(self, judgment: Judgment, pipeline: JudgmentPipeline) -> Optional[dict]:
        ...
        from cynic.brain.cognition.cortex.decide import _ACT_REALITIES
    ...
    async def evolve(self) -> dict[str, Any]:
        ...
        from cynic.brain.cognition.cortex.probes import PROBE_CELLS, ProbeResult
