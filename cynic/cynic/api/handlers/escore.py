...
class EScoreHandlers(HandlerGroup):
    ...
    async def _on_judgment_for_burn(self, event: Event) -> None:
        ...
        try:
            ...
            self._svc.cognition.escore_tracker.update("agent:cynic", "BURN", burn_score, reality=p.reality)
    ...
    async def _on_consciousness_changed(self, event: Event) -> None:
        ...
        try:
            ...
            self._svc.cognition.escore_tracker.update("agent:cynic", "HOLD", hold_score)
            if direction == "UP":
    ...
    async def _on_user_feedback(self, event: Event) -> None:
        ...
        try:
            ...
            self._svc.cognition.escore_tracker.update("agent:cynic", "JUDGE", judge_score)
            self._svc.cognition.escore_tracker.update("agent:cynic", "SOCIAL", WAG_MIN)
    ...
    async def _on_perception_received(self, event: Event) -> None:
        ...
        try:
            ...
            self._svc.cognition.escore_tracker.update("agent:cynic", "SOCIAL", social_score, reality=reality)
            self._svc.cognition.escore_tracker.update("agent:cynic", "HOLD", hold_score, reality=reality)
    ...
    async def _on_q_table_updated(self, event: Event) -> None:
        ...
        try:
            self._svc.cognition.escore_tracker.update("agent:cynic", "BUILD", HOWL_MIN)
            self._svc.cognition.escore_tracker.update("agent:cynic", "HOLD", WAG_MIN)
    ...
    async def _on_consensus_reached(self, event: Event) -> None:
        ...
        try:
            ...
            self._svc.cognition.escore_tracker.update("agent:cynic", "BUILD", q_score)
    ...
    async def _on_user_correction(self, event: Event) -> None:
        ...
        try:
            ...
            self._svc.cognition.escore_tracker.update("agent:cynic", "JUDGE", score)
