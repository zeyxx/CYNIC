...
async def test_empirical_test_uses_adapter():
    ...
    with patch("cynic.interfaces.mcp.claude_code_bridge.get_adapter") as mock_get:
        ...
        mock_adapter.start_empirical_test = AsyncMock(
            return_value={
                "job_id": "test-123",
                "status": "queued",
            }
...
async def test_job_status_uses_adapter():
    ...
    with patch("cynic.interfaces.mcp.claude_code_bridge.get_adapter") as mock_get:
        mock_adapter = AsyncMock()
        mock_adapter.poll_test_progress = AsyncMock(
            return_value={
                "status": "running",
...
async def test_get_results_uses_adapter():
    ...
    with patch("cynic.interfaces.mcp.claude_code_bridge.get_adapter") as mock_get:
        mock_adapter = AsyncMock()
        mock_adapter.get_test_results = AsyncMock(
            return_value={
...
async def test_axiom_irreducibility_uses_adapter():
    ...
    with patch("cynic.interfaces.mcp.claude_code_bridge.get_adapter") as mock_get:
        mock_adapter = AsyncMock()
        mock_adapter.test_axiom_irreducibility = AsyncMock(
            return_value={
                "axiom_impacts": [
                    {
                        "name": "PHI",
...
async def test_query_telemetry_uses_adapter():
    ...
    with patch("cynic.interfaces.mcp.claude_code_bridge.get_adapter") as mock_get:
        mock_adapter = AsyncMock()
        mock_adapter.query_telemetry = AsyncMock(
            return_value={
                "uptime_s": 3600.0,
...
async def test_ask_cynic_uses_adapter():
    ...
    with patch("cynic.interfaces.mcp.claude_code_bridge.get_adapter") as mock_get:
        mock_adapter = AsyncMock()
        mock_adapter.ask_cynic = AsyncMock(
            return_value={
                "q_score": 72,
                "verdict": "WAG",
                "confidence": 0.58,
...
async def test_learn_cynic_uses_adapter():
    ...
    with patch("cynic.interfaces.mcp.claude_code_bridge.get_adapter") as mock_get:
        mock_adapter = AsyncMock()
        mock_adapter.teach_cynic = AsyncMock(
            return_value={
                "status": "updated",
                "judgment_id": "j-123",
                "qtable_updated": True,
