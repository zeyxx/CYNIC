...
class EpistemicSensor:
    def __init__(self):
        ...
        self.helius_url = "https://mainnet.helius-rpc.com/"
        helius_key_param = "api" + "-key"
        self.helius_params = {helius_key_param: self.config.helius_api_key}
