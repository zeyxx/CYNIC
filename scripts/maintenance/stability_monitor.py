...
# Configuration
MONITOR_DURATION_MINUTES = 30  # Run for 30 minutes (can extend later)
...
async def main():
    ...
    if not PID_FILE.exists():
        print("❌ Bot not running! Start with: cd governance_bot && python bot.py")
        return 1
