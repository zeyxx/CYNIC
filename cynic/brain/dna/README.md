...
```python
from cynic.brain.dna.assembly import FAST_QUALITY_CHECK
...
```python
from cynic.brain.dna.assembly import Workflow
...
```python
from cynic.brain.dna.assembly import cynic_workflow
