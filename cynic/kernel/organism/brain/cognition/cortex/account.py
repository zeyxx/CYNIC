...
class AccountAgent:
    ...
    async def _check_thresholds(self) -> None:
        ...
        if self.total_cost_usd >= warning_threshold and not self._warning_sent:
            ...
            logger.warning("BUDGET WARNING: %.2f USD spent (limit=%.2f)", self.total_cost_usd, self.limit)
    ...
    def stats(self) -> dict:
        return {
            ...
            "usage_pct": round((self.total_cost_usd / self.limit) * 100, 2) if self.limit > 0 else 0
        }
