...
class TestJudgmentIdPropagation:
    ...
    async def test_executor_uses_payload_judgment_id(self):
        ...
        with patch("cynic.interfaces.api.handlers.judgment_executor.get_core_bus", return_value=mock_bus), \
             patch("cynic.interfaces.api.routers.core._write_guidance"):
        ...
        # Extract payload
        created_payload = created_event.dict_payload
    ...
    async def test_circuit_breaker_uses_payload_judgment_id(self):
        ...
        failed_payload = failed_event.dict_payload
