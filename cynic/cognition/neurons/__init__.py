...
Typical usage:
    from cynic.cognition.neurons import DOG_REGISTRY
    dog = DOG_REGISTRY.get('chokmah')
    verdict = await dog.judge(cell)

See Also:
    cynic.judges: Alternative judge implementations
    cynic.cognition.cortex: Orchestrator that coordinates dogs
    cynic.learning: Q-Table learning from dog judgments
"""
