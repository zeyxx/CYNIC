...
def test_user_message__bounded_confidence_valid():
    """user_confidence must be -bounded [0, 0.618] - valid values."""
    # At lower boundary
...
def test_user_message__bounded_confidence_invalid():
    """user_confidence must be -bounded [0, 0.618] - invalid values."""
    # Exceeds -bound (0.7 > 0.618)
    with pytest.raises(ValueError, match="user_confidence must be -bounded"):
...
def test_cynic_message__bounded_confidence_valid():
    """confidence must be -bounded [0, 0.618] - valid values."""
    # At lower boundary
...
def test_cynic_message__bounded_confidence_invalid():
    """confidence must be -bounded [0, 0.618] - invalid values."""
    # Exceeds -bound (0.73 > 0.618)
