    ...
    async def _write_consciousness(self) -> None:
        ...
        try:
            ...
            payload = {
                ...
                "lod": self._cognition.lod_controller.status()
                if hasattr(self._cognition.lod_controller, "status")
                else {},
            ...
            if (
                hasattr(self._cognition.escore_tracker, "state_manager")
                and self._cognition.escore_tracker.state_manager
            ):
            ...
            logger.warning(
                "ConsciousnessWriter: failed to write consciousness.json: %s", exc
            )
