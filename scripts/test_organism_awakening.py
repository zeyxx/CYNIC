...
async def run_awakening():
    ...
    print(
        f"Decision: {result_s1['routing']['mode']} -> Target: {result_s1['routing']['target']}"
    )
    ...
    result_s2 = await cynic.process_task(
        "Audit this fractal architecture for ethical alignment."
    )
    print(
        f"Decision: {result_s2['routing']['mode']} -> Target: {result_s2['routing']['target']}"
    )
