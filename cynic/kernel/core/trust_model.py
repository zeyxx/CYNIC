...
- Enables SYMBIOSIS axiom activation (requires both   = 38.2%)
- Enables co-decision blending (blended_conf = human_conf - cynic_conf)

-bounded: All confidence values  [0, MAX_CONFIDENCE=0.618]
"""
...
class TrustMetrics:
    ...
    human_confidence: float = 0.0  # -bounded [0, MAX_CONFIDENCE]
