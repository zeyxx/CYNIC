...
from cynic.integrations.gasdf.types import (
    GASdfExecutionResult,
    GASdfQuote,
    GASdfStats,
)
from cynic.integrations.near.executor import NEARExecutor
from cynic.integrations.near.types import (
    NEARExecutionResult,
...
class TestNEARIntegration:
    ...
    async def test_invalid_vote_type(self, near_executor):
        ...
        from cynic.integrations.near.types import NEARError
