...
Layer 3 transforms aggregated state (Layer 2) into -bounded verdicts through
...
class RoutingRule:
    ...
    Attributes:
        ...
        confidence: Rule confidence score (default 0.618, )
    """
...
class Layer3:
    ...
    async def judge(self, aggregated_state: LNSPMessage) -> LNSPMessage | None:
        ...
        3. Score each axiom
        4. Compute geometric-mean Q-Score (-weighted)
        ...
        # Compute Q-Score using geometric mean, -weighted
    ...
    def _compute_q_score(self, scores: list[float]) -> float:
        ...
        # -weight (golden ratio conjugate:  = 0.618)
        phi = 0.618
