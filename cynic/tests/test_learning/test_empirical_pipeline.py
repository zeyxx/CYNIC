...
from cynic.senses.empirical_sensor import EmpiricalSensor
from cynic.senses.sensor_interface import Observation
...
from cynic.core.phi import fibonacci, MAX_Q_SCORE
...
def test_deterministic_adapter_imports():
    ...
    from cynic.llm.adapters import DeterministicLLMAdapter
    from cynic.llm.adapters.test_adapter import DeterministicLLMAdapter as DirectImport
...
def test_empirical_learn_stage_imports():
    ...
    from cynic.cognition.cortex.judgment_stages import EmpiricalLearnStage
