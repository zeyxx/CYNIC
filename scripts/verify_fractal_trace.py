...
async def test_traceability():
    ...
    leaks_in_alpha = [e.type for e in alpha["events"] if e.metadata["instance_id"] == beta_id]
    leaks_in_beta = [e.type for e in beta["events"] if e.metadata["instance_id"] == alpha_id]
