...
async def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m cynic.interfaces.cli battles                    # 8h battles
  python -m cynic.interfaces.cli battles --duration 1h      # 1h battles
  python -m cynic.interfaces.cli battles --interval 60s     # 60s between battles
  python -m cynic.interfaces.cli battles --dry-run           # Test mode
        """,
    )
    parser.add_argument(
        "--duration",
