...
logger = logging.getLogger("cynic.kernel.organism.brain.cognition.neurons.sage")
...
class SageDog(LLMDog):
    ...
    async def _temporal_path(
        ...
        """
        from cynic.kernel.organism.brain.llm.temporal import temporal_judgment, fast_temporal_judgment
