...
3. Confidence is -bounded to MAX_CONFIDENCE (0.618)
...
class JudgeInterface(ABC):
    ...
    async def judge(self, proposal_text: str, context: dict[str, Any]) -> UnifiedJudgment:
        ...
        Raises:
            ValueError: If judgment violates -bounds or verdict constraints
        """
        pass
