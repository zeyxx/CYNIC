...
from cynic.kernel.core.phi import PHI_INV, PHI_INV_2, PHI_INV_3, MAX_Q_SCORE, phi_bound_score
...
logger = logging.getLogger("cynic.brain.cognition.neurons.janitor")
