...
class TestGovernanceEndpoints:
    ...
    def test_submit_proposal_missing_fields(self):
    ...
    def test_record_outcome_invalid_choice(self):
    ...
    def test_governance_status_gasdf_info(self):
    ...
    def test_governance_status_lnsp_info(self):
    ...
    def test_trigger_execution_no_gasdf(self):
    ...
    def test_endpoint_requires_governance_init(self):
...
class TestGovernanceModels:
    ...
    def test_proposal_request_validation(self):
        """ProposalRequest validates required fields."""
        from cynic.api.routers.governance import ProposalRequest
    ...
    def test_vote_request_validation(self):
        ...
        from cynic.api.routers.governance import VoteRequest
    ...
    def test_verdict_response_model(self):
        """VerdictResponse includes all required fields."""
        from cynic.api.routers.governance import VerdictResponse
    ...
    def test_governance_status_response_model(self):
        """GovernanceStatusResponse includes all required fields."""
        from cynic.api.routers.governance import GovernanceStatusResponse
