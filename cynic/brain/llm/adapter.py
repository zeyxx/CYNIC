...
logger = logging.getLogger("cynic.brain.llm.adapter")
...
class LLMRegistry:
    ...
    async def discover(
        ...
        if models_dir:
            try:
                from cynic.brain.llm.adapters.local_gguf import LlamaCppAdapter
                # Placeholder for listing models, in real it scans models_dir
                # ...
            except ImportError: pass

        # 2. Local Service (Level 1: Local Network)
        from cynic.brain.llm.adapters.local_service import OllamaAdapter
        ...
        from cynic.brain.llm.adapters.cli_bridge import CLIAdapter
        ...
        from cynic.brain.llm.adapters.cloud_api import AnthropicAdapter, GeminiAdapter
        # ...
