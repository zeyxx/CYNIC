...
class AnthropicAdapter(LLMAdapter):
    ...
    async def complete(self, request: LLMRequest) -> LLMResponse:
        ...
        try:
            ...
            return LLMResponse(
                content="", model=self.model, provider="anthropic", error=str(e)
            )
...
class GeminiAdapter(LLMAdapter):
    ...
    async def complete(self, request: LLMRequest) -> LLMResponse:
        if not self._key:
            return LLMResponse(
                content="", model=self.model, provider="gemini", error="No API Key"
            )
        ...
        try:
            ...
            return LLMResponse(
                content="", model=self.model, provider="gemini", error=str(e)
            )
