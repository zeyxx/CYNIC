...
from cynic.organism.organism import Organism, awaken
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    from cynic.api.state import set_state
    set_state(organism)
...
from cynic.api.routers.consciousness import router as router_consciousness
from cynic.api.routers.health import router as router_health
