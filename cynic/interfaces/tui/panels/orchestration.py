...
"""
    ...
    def _render_docker(self) -> Panel:
        ...
        table.add_row("cynic-kernel", "ðŸŸ¢ Running", "8000", "2h 34m")
        table.add_row("postgres-py", "ðŸŸ¢ Running", "5433", "2h 34m")
        table.add_row("ollama", "ðŸŸ¢ Running", "11434", "2h 34m")
...
"""
    ...
    def _render_health(self) -> Panel:
        ...
        table.add_row("cynic-kernel", "ðŸŸ¢ Healthy", "2.3%", "342 MB", "0")
        table.add_row("postgres-py", "ðŸŸ¢ Healthy", "1.1%", "128 MB", "0")
        table.add_row("ollama", "ðŸŸ¢ Healthy", "0.0%", "4.2 GB", "0")
