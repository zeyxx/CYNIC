...
pytestmark = pytest.mark.skip(
    reason="Old architecture removed in V5 - StateSnapshot class deleted"
)
...
class TestSnapshot:
    ...
    def test_snapshot_immutable(self):
        ...
        snapshot = StateSnapshot(memory={"key": "value"}, persistent={}, checkpoint={})
    ...
    def test_snapshot_returns_copies(self):
        ...
        snapshot = StateSnapshot(memory=state_data, persistent={}, checkpoint={})
