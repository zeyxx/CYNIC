...
Typical usage:
    from cynic.cognition import JudgmentPipeline, JudgmentOrchestrator
    pipeline = JudgmentPipeline(cell=governance_cell)
    judgment = await orchestrator.judge(pipeline)

See Also:
    cynic.core.consciousness: Consciousness level definitions
    cynic.organism: Organism architecture using cognition layer
